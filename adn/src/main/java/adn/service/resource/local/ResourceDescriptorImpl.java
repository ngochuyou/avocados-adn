...
public class ResourceDescriptorImpl<T> implements ResourceDescriptor<T> {
	...
	public ResourceDescriptorImpl(Class<T> type, ResourceManagerFactory resourceManager)
		...
		if (isIdAutoGenerated) {
			AnnotationBasedResourceValueGeneration generation = DefaultResourceIdentifierValueGeneration.INSTANCE;
	...
	private static class DefaultResourceIdentifierValueGenerator
			implements ResourcePropertyValueGenerator<Serializable> {

		public static final DefaultResourceIdentifierValueGenerator INSTANCE = new DefaultResourceIdentifierValueGenerator();
		...
		@Override
		public Serializable generateValue(ResourceManagerFactory factory, Object owner) {
			// TODO Auto-generated method stub
			return null;
		}
	...
	private static class DefaultResourceIdentifierValueGeneration implements AnnotationBasedResourceValueGeneration {
		...
		public static final DefaultResourceIdentifierValueGeneration INSTANCE = new DefaultResourceIdentifierValueGeneration();

		private final ResourcePropertyValueGenerator<Serializable> generator = DefaultResourceIdentifierValueGenerator.INSTANCE;
