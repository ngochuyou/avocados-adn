...
import adn.service.resource.metamodel.type.AbstractSynthesizedBasicType;
...
public class ResourcePersisterImpl<D> implements ResourcePersister<D>, EntityPersisterImplementor<D>, ClassMetadata,
	...
	public void generateEntityDefinition() {
		...
		for (int i = 0; i < propertySpan; i++) {
			...
			try {
				addColumnToResultSetMetadata(attr.getName(), propertyTypes[i]);
	...
	private void addColumnToResultSetMetadata(String attrName, Type type)
		...
		if (type instanceof AbstractSynthesizedBasicType) {
