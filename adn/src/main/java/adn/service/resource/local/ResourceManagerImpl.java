...
public class ResourceManagerImpl implements ResourceManager {
	...
	public <T> void manage(T instance, Class<T> type) {
		...
		Serializable identifier = descriptor.getIdentifier(instance);
		...
		context.add(identifier, instance);
	}
	...
	private <T> void typeCheck(Class<T> type) throws IllegalArgumentException {
