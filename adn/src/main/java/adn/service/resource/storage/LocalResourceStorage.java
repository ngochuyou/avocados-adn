...
public interface LocalResourceStorage extends Service {
	...
	SingleResourceResultSet select(Serializable identifier);

	ResourceResultSet select(Serializable[] identifier);
	...
	public static class ResourceResultSet implements ResultSet {
		...
		public ResourceResultSet(List<Object> rows, Class<?> type) {
		...
		public Object getCurrent() {
			...
			logger.debug(
					"Current row " + current + " null=" + String.valueOf((currentRow = rows.get(current)) == null));
		...
		public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
			// TODO Auto-generated method stub
			Object o = getObject(current);

			if (type.getClass().isAssignableFrom(o.getClass())) {
				return (T) o;
			}

			throw new SQLException(
					new ClassCastException("Unable to cast row " + columnIndex + " required type is" + type));
		}
	...
	public static class SingleResourceResultSet extends ResourceResultSet {

		private final Object row;

		public SingleResourceResultSet(Object row, Class<?> type) {
