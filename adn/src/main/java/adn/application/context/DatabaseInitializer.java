...
public class DatabaseInitializer implements ContextBuilder {
	...
	public Admin getAdmin() {
		...
		admin.setPhoto(LocalResourceStorageImpl.DEFAULT_USER_PHOTO_NAME);
	...
	private void insertCustomer() {
		...
		if (session.get(Customer.class, "adn.customer.0") == null) {
			...
			customer.setPhoto(LocalResourceStorageImpl.DEFAULT_USER_PHOTO_NAME);
	...
	private void insertManager() {
		...
		if (session.get(Personnel.class, "adn.personnel.manager.0") == null) {
			...
			manager.setPhoto(LocalResourceStorageImpl.DEFAULT_USER_PHOTO_NAME);
