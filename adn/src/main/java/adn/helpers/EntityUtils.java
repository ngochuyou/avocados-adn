...
public class EntityUtils {
	...
	public static <T extends Entity> String getIdentifierPropertyName(T instance) {
		return getEntityPersister(getPersistentClass(instance)).getIdentifierPropertyName();
	}
