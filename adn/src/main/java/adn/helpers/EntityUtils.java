...
public class EntityUtils {
	...
	public static <T> String getIdentifierPropertyName(Class<T> type) {
		return getSessionFactory().getMetamodel().entityPersister(type).getIdentifierPropertyName();
	}

	public static <T> String getIdentifierPropertyName(T instance) {
		return getSessionFactory().getMetamodel().entityPersister(getPersistentClass(instance))
