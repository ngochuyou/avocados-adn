...
const FETCHED_PRODUCT_COLUMNS = ["id", "name", "rating", "price", "images", "description", "active"];
					...
					>
						...
						>
							<form onSubmit={onSubmit}>
								...
								<div className="uk-margin">
									<label className="uk-label backgrounds">Price</label>
									<input
										name="price"
										type="number"
										min="0"
										...
										value={model.price}
									/>
									<p className="uk-text-danger">{errors.price}</p>
								</div>
								<div className="uk-margin">
